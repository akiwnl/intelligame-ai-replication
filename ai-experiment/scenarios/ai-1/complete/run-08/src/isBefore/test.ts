...
describe('isBefore', () => {
  // Test case 1: Basic functionality (date is before dateToCompare)
  ...
  // Test case 2: Date is after dateToCompare (example from JSDoc)
  ...
  it('should return true if the first date is before the second by milliseconds', () => {
    const date1 = new Date(2023, 0, 1, 12, 0, 0, 0);
  ...
  it('should return true if the first date is before the second by seconds', () => {
    const date1 = new Date(2023, 0, 1, 12, 0, 0, 0);
  ...
  it('should return true if the first date is before the second by minutes', () => {
    const date1 = new Date(2023, 0, 1, 12, 0, 0, 0);
  ...
  it('should return true if the first date is before the second by hours', () => {
    const date1 = new Date(2023, 0, 1, 12, 0, 0, 0);
  ...
  it('should return true if the first date is before the second by days', () => {
  ...
  it('should handle timestamp inputs correctly', () => {
    const date1 = new Date(2023, 0, 1, 23, 59, 59, 999).getTime();
    const date2 = new Date(2023, 0, 2, 0, 0, 0, 0).getTime();
    const result = isBefore(date1, date2);
    expect(result).toBe(true);
  });
  ...
  it('should handle string inputs (ISO 8601) correctly', () => {
    const date1 = '2023-01-01T23:59:59.999Z';
    const date2 = '2023-01-02T00:00:00.000Z';
    const result = isBefore(date1, date2);
    expect(result).toBe(true);
  });
