...
describe("isAfter", () => {
  ...
  it("should work with timestamp inputs", () => {
    const timestamp1 = new Date(2023, 5, 16).getTime();
    const timestamp2 = new Date(2023, 5, 15).getTime();
  ...
  it("should work with date string inputs", () => {
    const dateString1 = "2023-07-02T12:00:00Z";
    const dateString2 = "2023-07-01T12:00:00Z";
