...
describe("isAfter", () => {
  ...
  it("compares dates with different times correctly", () => {
    const date1 = new Date(2023, 0, 1, 12, 0, 0);
    const date2 = new Date(2023, 0, 1, 11, 59, 59);
    const result = isAfter(date1, date2);
    expect(result).toBe(true);
  });
  ...
  it("accepts strings as date arguments", () => {
    const dateString1 = "1989-07-10T00:00:00Z";
    const dateString2 = "1987-02-11T00:00:00Z";
