...
describe("isAfter", () => {
  ...
  it("should accept timestamps as input", () => {
    const date1 = new Date(2023, 0, 2).getTime();
    const date2 = new Date(2023, 0, 1).getTime();
    const result = isAfter(date1, date2);
    expect(result).toBe(true);
  });

  it("should accept strings as input", () => {
    const date1 = "2023-01-02T10:00:00.000Z";
  ...
  it("should compare dates with different time components correctly", () => {
    ...
    const date2 = new Date(2023, 0, 1, 9, 59, 59, 999);
    const result = isAfter(date1, date2);
    expect(result).toBe(true);
  });
});
