...
describe("isAfter", () => {
  ...
  it("returns true if dates are equal but first has later milliseconds", () => {
    const date1 = new Date(2023, 5, 15, 10, 30, 0, 1);
    const date2 = new Date(2023, 5, 15, 10, 30, 0, 0);
    const result = isAfter(date1, date2);
    expect(result).toBe(true);
  });
  ...
  it("accepts strings as arguments", () => {
    const dateString1 = "2026-01-01T00:00:00Z";
    const dateString2 = "2025-12-31T23:59:59Z";
