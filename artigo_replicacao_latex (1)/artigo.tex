...
\nextinstitute
  ...
  \email{carvalhokaike69@gmail.com, sergiomurilo-cardoso@homail.com,}
...
Desde então, modelos de linguagem de larga escala (LLMs) passaram a gerar código e
testes de forma cada vez mais competente, deslocando parte da atividade de
...
Espelhando a §3.7 do estudo original, ajustada à substituição de humanos por IA.
...
gerados (efeito grande), confirmando, no contexto de IA, o achado central de
...
condicionais e controlar a contaminação dos dados de treino, fortalecendo a
validade externa.
